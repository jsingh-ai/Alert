...
async function main() {
  ...
  async function template(name: string, buttonLabel: string, color: string, targets: Array<{ department: string; issue: string; message?: string | null; priority?: PriorityValue }>) {
